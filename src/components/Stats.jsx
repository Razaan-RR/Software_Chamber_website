...
function Stats() {
  return (
    <section className="bg-white text-black py-16 px-6 md:px-20">
      <h1 className="stats-heading text-3xl md:text-5xl font-semibold text-center">
        <SparklesIcon className="sparkles-icon w-10 h-10 text-teal-400 inline-block" />
        At Software Chamber,
        <span className="text-gray-900 font-bold">
          <span className="text-gray-400 font-semibold"> we specialize</span> in
          <br />
        ...
        <span className="block text-gray-400 font-semibold mt-2">
          ...
          <ArrowTrendingDownIcon
            className="arrow-icon w-12 h-12 text-black inline-block ml-2"
            style={{ transform: "rotate(-180deg)" }}
          />
        </span>
      </h1>

      <div className="stats-container mt-12 flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="stats-numbers text-left space-y-10">
          <div>
            <p className="stat-number text-3xl font-bold font-bricolage">20+</p>
            <p className="feature-desc text-gray-500 font-outfit">
              Tech Partners
            </p>
          </div>
          <div>
            <p className="stat-number text-3xl font-bold font-bricolage">
              150+
            </p>
            <p className="feature-desc text-gray-500 font-outfit">
              Project Completed
          ...
          {[
            ...
            <div key={index} className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="feature-desc text-gray-500 text-sm font-outfit">
                  {item.desc}
                </p>
              </div>
            </div>
