      ...
      <div className="relative z-10">
        ...
        <div className="relative flex items-center justify-center mt-20">
          <div className="relative w-full max-w-4xl">
            {/* === Left labels === */}
            <div className="absolute -left-48 top-[70px] flex items-center gap-2 z-30 bg-gradient-to-r from-[#5F5F5F] to-[#1E1E1E] px-4 py-2 text-xs text-white">
            ...
            <div className="absolute -left-52 top-[130px] flex items-center gap-2 z-30 bg-gradient-to-r from-[#5F5F5F] to-[#1E1E1E] px-4 py-2 text-xs text-white">
              <div className="bg-white w-3 h-3 rounded-sm flex items-center justify-center">
                <svg
                  width="8"
                  height="6"
            ...
            {/* === Right labels === */}
            <div className="absolute -right-52 top-[70px] flex items-center gap-2 z-30 bg-gradient-to-r from-[#5F5F5F] to-[#1E1E1E] px-4 py-2 text-xs text-white">
              <div className="bg-white w-3 h-3 rounded-sm flex items-center justify-center">
                <svg
                  width="8"
                  height="6"
            ...
            <div className="absolute -right-48 top-[150px] flex items-center gap-2 z-30 bg-gradient-to-r from-[#5F5F5F] to-[#1E1E1E] px-4 py-2 text-xs text-white">
              <div className="bg-white w-3 h-3 rounded-sm flex items-center justify-center">
                <svg
                  width="8"
                  height="6"
            ...
            <div className="relative rounded-2xl backdrop-blur-md bg-white/10 px-8 pt-10 pb-12 shadow-xl border border-white/10 z-10">
              <div className="grid md:grid-cols-2 gap-6 items-start">
                ...
                <div className="relative h-52 rounded-xl bg-white/10 border border-white/10 p-6 overflow-hidden">
                  ...
                  <div className="absolute top-[75%] right-[10%] w-[35%] bg-[#6DECB9] text-black text-xs px-4 py-1.5 rounded-md shadow-md">
                    Website
                  </div>
                </div>
